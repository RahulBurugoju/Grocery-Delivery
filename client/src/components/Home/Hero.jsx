...
import { heroSectionData } from '../../assets/assets.js'
...
function Hero() {
  return (
    <section className='relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex items-center'>
        ...
        <div className='relative max-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full'>
            <div className='max-w-xl xl:pl-10'>
                ...
                >
                    Nourish your hom with <span className='text-orange-300'>Earth,s finest</span>
                </h1>
                <p
                ...
                <div className='flex place-items-center gap-2'>
                    ...
                    <Link
                        to='/products'
                        className="px-7 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all flex-center gap-2 border border-white/20"
                    >
                       Browse Categories
                    </Link>
                </div>
