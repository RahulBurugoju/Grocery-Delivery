      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col animate-slide-in-right">
        ...
        <div className="flex items-center justify-between p-5 border border-app-border">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium">TYour Cart</h2>
            <span className="px-2 py-0.5 text-xs font-seibold bg-app-cream roundede-full">
              {items.length} items
            </span>
          </div>
          <button
            onClick={() => setIsCartOpen(false)}
            className="p-2 roundede-xl hover:bg-app-cream transition-colors"
          >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    {/*quantity increase/decrease btn's */}
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() =>
