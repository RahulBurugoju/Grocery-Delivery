...
import { Home, ArrowLeftIcon, LeafIcon, StarIcon, MinusIcon, PlusIcon, ShoppingCartIcon, ArrowRightIcon } from "lucide-react";
...
function ProductPage() {
  ...
  useEffect(() => {
    ...
    setProduct(product);
    setRelatedProducts(dummyProducts.filter((p) => p.category == product.category));
    setLoading(false);
  }, [id, navigate]);
          ...
          <div className="grid md:grid-cols-2 gap-1">
            ...
            <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
              ...
              <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                {product.isOrganic && (
                  <span className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold bg-app-green text-white riunded-full">
            ...
            <div className=" flex flex-col justify-center p-6 md:p-10">
              ...
              {product.rating > 0 && (
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-am text-app-text-light">
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-12 mb-44">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <Link className="text-sm font-emibold text-app-orange hover:text-app-orange-dark flex items-center gap-1 transition-colors" to={`/products?category=${product.category}`}>
