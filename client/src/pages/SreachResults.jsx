...
function SreachResults() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    setProducts(dummyProducts.filter((product) => (
        ...
        <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-sm text-app-text-light mb-6 max-w-mb mx-auto">
              We couldn't find any products matching "geg". Try a different search term.
              </p>
